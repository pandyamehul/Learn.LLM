...
RUN_NAME = "2024-09-13_13.04.39" # run name from your finetuning run on wandb.ai
PROJECT_RUN_NAME = f"{PROJECT_NAME}-{RUN_NAME}"
REVISION = "e8d637df551603dc86cd7a1598a8f44af4d7ae36" # commit hash from your finetuning run on HF
